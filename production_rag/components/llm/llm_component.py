...
from production_rag.components.llm.prompt_helper import get_prompt_style
from production_rag.paths import models_cache_path, models_path
...
class LLMComponent:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        if settings.llm.tokenizer and settings.llm.mode != "mock":
            ...
            try:
                ...
                logger.warning(
                    ...
                    f"https://docs.productionrag.dev/installation/getting-started/troubleshooting#tokenizer-setup."
        ...
        match settings.llm.mode:
            ...
            case "sagemaker":
                try:
                    from production_rag.components.llm.custom.sagemaker import SagemakerLLM
                except ImportError as e:
                    raise ImportError(
            ...
            case "ollama":
                ...
                if ollama_settings.autopull_models:
                    from production_rag.utils.ollama import check_connection, pull_model
