...
from production_rag.paths import models_cache_path
...
class EmbeddingComponent:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        match embedding_mode:
            ...
            case "sagemaker":
                try:
                    from production_rag.components.embedding.custom.sagemaker import (
                        SagemakerEmbedding,
                    )
                except ImportError as e:
                    raise ImportError(
            ...
            case "ollama":
                ...
                if ollama_settings.autopull_models:
                    if ollama_settings.autopull_models:
                        from production_rag.utils.ollama import (
                            check_connection,
                            pull_model,
                        )
