...
from production_rag.open_ai.openai_models import (
    OpenAICompletion,
    OpenAIMessage,
)
from production_rag.server.chat.chat_router import ChatBody, chat_completion
...
def prompt_completion(
    ...
    "model":"production-grade-rag","choices":[{"index":0,"delta":{"content":"Hello"},
    "finish_reason":null}]}
    ```
    """
